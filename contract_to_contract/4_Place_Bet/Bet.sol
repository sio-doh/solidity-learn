...
contract Bet {
	...
	// calculates the payout of a bet based on the score difference between two teams
    ...
    function placeBet(Game.Teams choice) external payable returns (uint256) {
        uint256 payout = calculatePayout(msg.value, getScoreDifference(choice)); 
        return payout;
    }
}